...
$pdf->SetTitle('Cancelled Transactions Reports');
...
// add a page
$pdf->AddPage('L', 'A4');
$heading = '<h1>Cancelled Transactions Reports</h1>';
...
$table .='<tr>
		...
		$query = $this->db->query("SELECT * FROM cart WHERE order_status = 'CANCELLED' ORDER BY id DESC");
		$data = array($query);
